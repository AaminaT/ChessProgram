...
TEST(MoveTest, DirectionFloats) {
    ...
    EXPECT_EQ(m2.get_direction(), coordinate(1,3));    
...
TEST(MoveTest, DirectionComplex) {
    ...
    EXPECT_EQ(m3.get_direction(), coordinate(-1,1));

    Move m4(new coordinate(12233,785131415), new coordinate(0,333333));
    EXPECT_EQ(m4.get_direction(), coordinate(0,0));    
}
